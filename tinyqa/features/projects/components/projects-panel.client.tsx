...
export function DashboardProjectsPanel() {
  ...
  const copyAppWebhookUrl = (projectId: string) => {
      ...
      <div className="flex-1 w-full">
        <div className="rounded-lg border border-amber-500/20 bg-amber-500/10 p-6">
          ...
          <p className="mt-3 max-w-2xl text-sm leading-7 text-white/50">
            ...
            <code className="text-amber-300">NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY</code>,
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div className="space-y-1.5">
              ...
              <input
                ...
                required
                className="w-full rounded-lg border border-white/10 bg-white/5 px-3 py-2 text-sm text-white placeholder:text-white/25 transition-colors focus:border-white/30 focus:outline-none"
              />
            </div>
            <div className="space-y-1.5">
                ...
                >
                  ...
                  <div className="mt-3 rounded-lg border border-white/5 bg-white/5 p-3">
                    ...
                    <p className="text-xs text-white/45">
                      Install the TinyQA GitHub App on this repo, then set its webhook
                      URL to:
                    </p>
                    <div className="mt-2 flex items-center gap-2">
                      <code className="flex-1 break-all text-xs leading-relaxed text-white/50">
                        {getAppWebhookUrl()}
                      </code>
                      <button
                        onClick={() => copyAppWebhookUrl(project.id)}
